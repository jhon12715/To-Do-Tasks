...
class TaskDiffCallback: DiffUtil.ItemCallback<TaskUI>(){
    ...
    override fun areContentsTheSame(oldItem: TaskUI, newItem: TaskUI): Boolean = oldItem.completedSubtask == newItem.completedSubtask && oldItem.totalSubTask == newItem.totalSubTask && oldItem.isCompleted == newItem.isCompleted
