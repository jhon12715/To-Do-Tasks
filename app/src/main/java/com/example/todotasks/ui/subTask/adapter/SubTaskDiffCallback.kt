...
class SubTaskDiffCallback: DiffUtil.ItemCallback<SubTask>(){
    ...
    override fun areContentsTheSame(oldItem: SubTask, newItem: SubTask): Boolean = oldItem.title == newItem.title && oldItem.completed == newItem.completed && oldItem.priority == newItem.priority
